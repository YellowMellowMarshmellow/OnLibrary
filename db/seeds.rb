...
books_data = [
  {
    ...
    user: user,
    image_path: "app/assets/images/The_little_Prince_cover.jpg"
  },
  {
    title: "1984",
    ...
    user: user,
    image_path: "app/assets/images/1984_Cover.jpg"
  },
  {
    ...
    user: user,
    image_path: "app/assets/images/Harry_Potter_cover.jpeg"
  },
  {
    ...
    user: user,
    image_path: "app/assets/images/The_great_gatsby_cover.jpg"
  },
  {
    title: "The Hobbit",
    ...
    user: user,
    image_path: "app/assets/images/The_Hobbit_cover.jpg"
  },
]

books_data.each do |book_data|
  image_path = book_data.delete(:image_path)
  book = Book.create!(book_data)
  if image_path && File.exist?(image_path)
    book.image.attach(io: File.open(image_path), filename: File.basename(image_path))
